        ...
        >
                <div className="cardoption">
                    ...
                    <div className="Landpetsbtn">
                        <div className="land" style={{backgroundColor: isLandorpet && "#a16cfd"}} onClick={()=>setisLandOrPet(!isLandorpet)}>
                            Lands
                        </div>
                        <div className="pets" style={{backgroundColor: !isLandorpet && "#a16cfd"}} onClick={()=>setisLandOrPet(!isLandorpet)}>
                            Pets
                        </div>
                    </div>
                    ...
                    {balance && isLandorpet && <div className="allLands">
                            ...
                            <div className="commonLand">
                                ...
                                <div className="llandname">
                                    Legendary
                                </div>
                                <div className="llandcount">
                                    {legenbal}
                                </div>
                                <div className="landprice">
                                    {plegend}
                    ...
                    {balance && !isLandorpet && <div className="nobala">
                        <div className="thereisno">Coming Soon!</div>
                    </div>}
